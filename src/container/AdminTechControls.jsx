...
// delete
  ...
  return (
    <div className="p-4 max-w-7xl mx-auto">
      <h2 className="text-lg sm:text-2xl font-bold text-purple-400 text-start mb-6">Teachers:</h2>
  <form onSubmit={handleAddTeacher} className="mb-6 p-4 rounded-lg ">
        <h3 className="text-lg text-start font-semibold mb-4 text-black/80">Add New Teacher</h3>
        <div className="flex flex-col sm:flex-row sm:items-center gap-4">
          ...
          <button
            type="submit"
            className="bg-purple-200 flex items-center gap-2 text-purple-600 px-6 py-2 rounded hover:bg-purple-300 duration-300 w-full sm:w-auto"
          >
          Add Teacher <GoPlus></GoPlus> 
          </button>
        </div>
      </form>
        ...
        {teachers.map((teacher) => (
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
              ...
              <button
                className="flex justify-center items-center gap-1 bg-purple-200 text-purple-600 px-4 py-1.5 rounded hover:bg-purple-300 duration-300 w-full sm:w-auto"
                disabled
              >
